...
function AuthProfileBadge({ profile }: { profile: Application["auth_profile"] }) {
  const value = profile === "proof_bound" ? "proof_bound" : "legacy";
  return <span className="inline-flex rounded-full bg-gray-100 px-2 py-0.5 text-xs font-medium text-gray-600 dark:bg-gray-800 dark:text-gray-300">{value}</span>;
}
