...
export default function ApplicationsPage() {
  ...
  async function createOrganization() {
    ...
    try {
      ...
      setError(reportClientError(createError, "Unable to create the organization. Try again."));
    } finally {
      setBusy(false);
    }
  }
  ...
  async function createApplication() {
    ...
    try {
      ...
      setError(reportClientError(createError, "Unable to create the application. Try again."));
    } finally {
      setBusy(false);
    }
  }
