...
export default function Error({ reset }: { error: Error & { digest?: string }; reset: () => void }) {
  return (
    <main className="flex min-h-screen items-center justify-center p-6">
      <section className="w-full max-w-md rounded-2xl border border-error-200 bg-error-50 p-6 text-error-800 dark:border-error-500/30 dark:bg-error-500/10 dark:text-error-200" role="alert">
